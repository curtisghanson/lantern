...
use Lantern\AuthBundle\Form\GroupType;
...
class GroupController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LanternAuthBundle:Group')->findAll();

        return $this->render('LanternAuthBundle:Group:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    */
    ...
    public function viewAction($id)
    {
        ...
        $entity = $em->getRepository('LanternAuthBundle:Group')->find($id);
